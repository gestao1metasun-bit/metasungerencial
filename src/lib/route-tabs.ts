...
export const ROUTE_TABS: Record<string, { default: string; tabs: SubTab[] }> = {
  ...
  "/analytics": {
    default: "visao",
    tabs: [
      { value: "visao", label: "Visão Executiva", group: "Amplo" },
      { value: "ebitda", label: "EBITDA & Margens", group: "Amplo" },
      { value: "roi", label: "ROI & Payback", group: "Amplo" },
      { value: "capital", label: "Capital de Giro", group: "Amplo" },
      { value: "alavancagem", label: "Alavancagem & Cobertura", group: "Amplo" },
      { value: "conversao", label: "Conversão & Inadimplência", group: "Amplo" },
      { value: "vendedores", label: "Capacidade Comercial", group: "Operação" },
      { value: "equipes", label: "Capacidade Operacional", group: "Operação" },
      { value: "dre", label: "DRE Gerencial", group: "Operação" },
      { value: "financiamento", label: "Simulador Financiamento", group: "Privado" },
      { value: "expansao", label: "Análise de Expansão", group: "Privado" },
      { value: "cfo", label: "CFO / Controladoria", group: "Privado" },
      { value: "parecer", label: "Parecer Executivo", group: "Privado" },
      { value: "parametros", label: "Parâmetros Gerenciais", group: "Privado" },
    ],
  },
  "/cadastros": {
    default: "bancos",
